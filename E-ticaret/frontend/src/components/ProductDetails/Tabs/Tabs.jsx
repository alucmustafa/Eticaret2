...
import "./Tabs.css"
const Tabs = () => {
  const [activeTab,setActiceTab]=useState("desc");
  
  const handleTabClick=(e,tab)=>{ //bunu a nın özelliğiden dolayı sayfanın başına gitmemesi için yazdık.
    e.preventDefault();
    setActiceTab(tab)
  }
  return (
    ...
    <ul className="tab-list">
      ...
      <li>
        <a href="#" className={`tab-button ${activeTab==="review"?"active":""}`} onClick={(e)=>handleTabClick(e,"review")}>
          Reviews
        </a>
      </li>
    </ul>
